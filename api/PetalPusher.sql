...
create table payments (id int auto_increment, order_id varchar(255), first_name varchar(255), last_name varchar(255), address varchar(255), apart varchar(255), city varchar(255), state varchar(255), zip_code int(11), phone varchar(255), e_mail varchar(255), primary key(id));
