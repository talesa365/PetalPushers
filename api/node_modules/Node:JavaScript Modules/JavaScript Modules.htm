<!DOCTYPE html>
<!-- saved from url=(0020)http://jsmodules.io/ -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="./JavaScript Modules_files/all.css" rel="stylesheet" type="text/css">
    <script src="./JavaScript Modules_files/all.js" type="text/javascript"></script>
    <link rel="icon" type="image/png" href="http://jsmodules.io/images/js-logo.png">
...
.en-markup-crop-options div div:first-of-type {
  ...
  <body class="index" data-feedly-mini="yes">
    <div class="logo">
      <p><a href="http://jsmodules.io/">JavaScript Modules</a></p>
    </div>

    <main>
      <content>
        <p>The next version of JavaScript comes with a module system heavily
inspired by Node.js modules.<br>Here’s how it works.</p>

<h1>Creating a Module</h1>

<p>We’re going to build a simple <code>asap</code> module, which lets you schedule some
...
everywhere.<a href="http://jsmodules.io/#footnote-1"><sup>1</sup></a></p>

<p>We start by creating a new file for this module. We’ll call it <code>asap.js</code>.
...
<p>Now that we’ve exported <code>later</code>, we can import it in another module.</p>
...
<p>It can be convenient to import all of a module’s named exports into a
...
<p>These names are also available in the module’s local scope, so you can
...
<p><span id="footnote-1"><sup>1</sup> A production-quality version of this library would be more
detailed, but this will do for our purposes.</span></p>

      </content>

      <footer>
        <a href="http://jsmodules.io/cjs.html">Compared to CommonJS</a>
      </footer>
    </main>

  

<iframe id="rdbIndicator" width="100%" height="270" border="0" src="./JavaScript Modules_files/indicator.html" style="display: none; border: 0; position: fixed; left: 0; top: 0; z-index: 2147483647"></iframe><div id="feedly-mini" title="feedly Mini tookit"></div></body></html>